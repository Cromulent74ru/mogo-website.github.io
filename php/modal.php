<?php
    ...
    $mail->Subject = 'Узнать больше, заявка';
    $mail->Body    = 'Имя пользователя: ' . $name . '</br>' . 'Фамилия пользователя: ' . $surname . '</br>' . 'Телефон пользователя: ' . $phone . '</br>' . 'Почта пользователя: ' . $email;
    $mail->AltBody = '';
